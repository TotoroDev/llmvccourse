...
<section id="login" class="section">
    <div class="container tagline">
        ...
        <form:form action="/login" method="post" modelAttribute="loginForm">
            ...
            <label>Password</label> <form:input path="password" type="text"/><br/>
            <form:button value="Login" id="submit" name="Login">Login</form:button>
        </form:form>
        <a class="card-title" href="/register">Register new user? Click here</a>
    </div>
</section>
<!-- #products -->
